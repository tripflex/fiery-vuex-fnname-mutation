  ...
  actions: {
    ...fieryBindings({
      ...
      loadTodos(context, payload, $fiery): Todo[] {
        return $fiery(thisDB, TodoOptions, "setTodos")
      },
      loadActualTodos(context, payload, $fiery): Todo[] {
        return $fiery(thisDB, TodoOptions, "setActualTodos")
      },
